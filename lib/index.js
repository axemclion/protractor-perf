...
module.exports.run = function(configFilePath) {// Added for Protractor-Perf
	//console.log("Start startPPerf");
	var ConfigParser = require('protractor/lib/configParser');
	var configParser = new ConfigParser();
	console.log("configFile is " +configFilePath);
	if (!fs.existsSync(configFilePath)) {
	 	//console.log("File does not exists");
	 	 if (fs.existsSync('./protractor.conf.js')) {
   			 configFilePath = './protractor.conf.js';
  		  }    
    }
	...
	require('..').getConfig(configParser.getConfig(), function(data) {
	 ...
	 // console.log("Running startPPerf");
	})
};